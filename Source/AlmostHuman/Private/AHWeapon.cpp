...
void AAHWeapon::OnRep_HitScanTrace()
{
	// Play cosmetic FX
...
void AAHWeapon::ServerFire_Implementation()
{
	Fire();
}

bool AAHWeapon::ServerFire_Validate()
{
	return true;
}
...
void AAHWeapon::PlayImpactEffects(EPhysicalSurface SurfaceType, FVector ImpactPoint)
{
...
void AAHWeapon::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME_CONDITION(AAHWeapon, HitScanTrace, COND_SkipOwner);
}